        ...
        <div className="grid lg:grid-cols-2 gap-10">
          {[
            ...
            },
            {
              ...
              desc: "Our mission is to deliver innovative environmental solutions that transform waste into valuable resources while advancing renewable energy for a cleaner and more sustainable future.",
             points: [
  "Deliver integrated waste management solutions",
  "Transform waste into valuable resources and energy",
  "Support bio mining and windrow composting projects",
  "Power sustainable growth through solar solutions",
  "Advance pyrolysis and circular economy technologies",
],
              x: 30,
              delay: 0.15,
            },
