...
const contacts = [
  ...
  { icon: <MapPin className="w-5 h-5" />, label: "Address", values: ["Sy. No: 41/1, Veerenahalli Village, Virgonagar Industrial Estate, Bidarahalli Hobli, Virgonagar Post, Bangalore - 560049"] },
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="mb-3" style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "clamp(1.4rem, 2.5vw, 1.9rem)", color: "#053114", lineHeight: 1.2 }}>
              Reddonatura India <em style={{ color: "#178B4C", fontStyle: "italic" }}>Private Limited</em>
            </h2>
            ...
            <div className="space-y-6">
              {contacts.map((c, i) => (
                <motion.div key={c.label} initial={{ opacity: 0, x: -16 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.1 * i }}
                  ...
                  <div className="w-11 h-11 flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "rgba(23,139,76,0.1)", color: "#178B4C" }}>{c.icon}</div>
                  <div>
          ...
          <motion.div initial={{ opacity: 0, x: 24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }}>
            <div className="p-8" style={{ border: "1px solid rgba(23,139,76,0.15)", backgroundColor: "#ffffff" }}>
              ...
              <form className="space-y-4">
                ...
                <button type="submit" className="w-full py-3 text-[11.5px] tracking-[0.14em] uppercase hover:opacity-90 transition-opacity"
                  style={{ backgroundColor: "#053114", color: "#ffffff", fontFamily: "'DM Sans', sans-serif", fontWeight: 600 }}>
                  Send Message
                </button>
              </form>
            </div>
      ...
      <section style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="flex items-end gap-3 mb-8">
            <span style={{ fontFamily: "'Playfair Display', Georgia, serif", fontStyle: "italic", fontWeight: 400, fontSize: "clamp(1.6rem, 3vw, 2.2rem)", color: "#178B4C", lineHeight: 1 }}>Find</span>
          ...
          <div className="mt-4 flex items-start gap-2">
            <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: "#178B4C" }} />
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: "0.9rem", color: "#053114" }}>
              Sy. No: 41/1, Veerenahalli Village, Virgonagar Industrial Estate, Bidarahalli Hobli, Virgonagar Post, Bangalore – 560049
            </p>
          </div>
        </div>
      </section>
