...
import { PageLayout, Section, SectionLabel, FeatureCard, SpecsTable, FAQAccordion, PageCTA, MachineGallery, AnimatedNumber } from "../PageLayout";
...
const biogasTypes = [
  ...
  },
  {
    ...
    image: "https://5.imimg.com/data5/SELLER/Default/2022/6/XV/IN/NY/16565063/animal-waste-biogas-plant-500x500.jpg",
  },
  {
    id: "geomembrane",
    label: "Geo Membrane",
    ...
    image: "https://www.pig333.com/3tres3_common/art/pig333/18918/biogas_258872.png",
  },
  {
    id: "floating",
    label: "Floating Drum",
    ...
    image: "https://cpimg.tistatic.com/07352368/b/5/Floating-Dome-Biogas-Plant.jpg",
  },
];
...
Each biogas plant is configured based on daily waste input, site conditions, and intended energy usage. System capacity, digester volume, and auxiliary components are selected to ensure stable operation and predictable performance over extended service life. 
          ...
          <motion.div initial={{ opacity: 0, x: 24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }}>
            <div style={{ border: "2px solid #178B4C", overflow: "hidden", boxShadow: "0 20px 45px rgba(5,49,20,0.15)" }}>
              <img src={Biogas} alt="RN Biogas Plant" className="w-full" style={{ maxHeight: "400px", objectFit: "cover" }} />
            </div>
          </motion.div>
        </div>
      </Section>
