...
import Biomining from "../../../imports/biomingprocess.png";
import Biominingimg from "../../../imports/windrow1.png";
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <motion.div initial={{ opacity: 0, x: 24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }}>
            <div style={{ border: "2px solid #178B4C", overflow: "hidden", boxShadow: "0 20px 45px rgba(5,49,20,0.15)" }}>
              <img src={Biominingimg} alt="Biomining — landfill processing" className="w-full" style={{ maxHeight: "420px", objectFit: "cover" }} />
            </div>
          </motion.div>
        </div>
      </Section>
...
<section className="w-full">
  ...
  >
    <img
      src={Biomining}
      alt="Biomining — landfill processing"
